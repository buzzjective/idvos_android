...
//    private final static int PIXEL_FORMAT = ImageFormat.JPEG;
    private final static int PREFERRED_CAPTURE_WIDTH = 800;
//    private final static int PREFERRED_CAPTURE_WIDTH = 640;
    private final static int PREFERRED_CAPTURE_HEIGHT = 600;
//    private final static int PREFERRED_CAPTURE_HEIGHT = 480;
     ...
     */
    public void swapCamera(int index) throws Exception{
...
//        cameraParams.setFlashMode(FlashL);
        Camera.getCameraInfo(this.mCameraIndex, mCurrentDeviceInfo);
...
//        cameraParams.setFlashMode(FlashL);
    ...
    private void configureCaptureSize(int preferredWidth, int preferredHeight) {
        ...
        Log.e("maxFrameSize",mCaptureFPS+"");
        ...
        Log.e("maxWIdthHeight",maxw+","+ maxh);
